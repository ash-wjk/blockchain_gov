...
class ProgressGraph extends Component{
  render () {
    const data = [
      {name: 'Jul',pv: 1300, amt: 2400},
      {name: 'Jun',pv: 2400, amt: 2210},
      {name: 'May',pv: 3800, amt: 2290},
      {name: 'Apr',pv: 3908, amt: 2000},
      {name: 'Mar',pv: 4800, amt: 3800},
      {name: 'Feb',pv: 5398, amt: 2400},
      {name: 'Jan',pv: 6400, amt: 1398},
    ];
